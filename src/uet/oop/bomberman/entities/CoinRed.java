...
public class CoinRed extends EntityCanDead {
    ...
    public void goLeft() {
        x -= speed;
        if (timing % 21 == 0) {
            img = Sprite.coinRed_left1.getFxImage();
        } else if (timing % 21 == 7) {
            img = Sprite.coinRed_left2.getFxImage();
        } else if (timing % 21 == 14) {
            img = Sprite.coinRed_left3.getFxImage();
        }
    }
    ...
    public void goRight() {
        x += speed;
        if (timing % 21 == 0) {
            img = Sprite.coinRed_right1.getFxImage();
        } else if (timing % 21 == 7) {
            img = Sprite.coinRed_right2.getFxImage();
        } else if (timing % 21 == 14) {
            img = Sprite.coinRed_right3.getFxImage();
        }
    }
